    ...
    <div class="topnav_bd w1210 bc">
        ...
        <div class="topnav_right fr">
            <?php if(!empty($_SESSION['user_name'])): ?><ul>
                    <li>您好，【<?php echo (session('user_name')); ?>】欢迎来到京西！[<a href="<?php echo U('User/logout');?>">退出系统</a>] [<a href="<?php echo U('User/regist');?>">免费注册</a>] </li>
                    <li class="line">|</li>
                    <li>我的订单</li>
                    <li class="line">|</li>
                    <li>客户服务</li>
			...
			<div class="login_form fl">
				<form action="/index.php/Home/User/regist.html" method="post">
					<ul>
						...
						<li class="checkcode">
							<label for="">验证码：</label>
							<input type="text" id="verify_code"  name="verify_code" maxlength="2" onkeyup="check_code()"/>
